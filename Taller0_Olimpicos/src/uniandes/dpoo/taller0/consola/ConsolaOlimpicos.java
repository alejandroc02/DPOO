...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Que pais representa un atleta en especifico");
	}
	...
	private void ejecutarPaisAtleta()
	{
		...
		Pais respuesta=atletaA.darPais();
		if (respuesta != null)
		{
				System.out.println("\n" + "El pais al qe pertenece el jugador es" + respuesta);
		}
		else
		{
